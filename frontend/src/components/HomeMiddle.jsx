...
function HomeMiddle() {
	return (
		<div className="homeMiddle">
			<div className="home__title sticky-top">
				<h5>Home</h5>
			...
			<div className="home__post">
				<div className="post__dp">
					<img
						src="https://pbs.twimg.com/profile_images/1202448673759621120/7xWI3WMY_400x400.jpg"
						alt="ProfilePicture"
					/>
				</div>
				<div className="post__tweet">
					<div className="post__input">
						<textarea maxlength="156"></textarea>
					</div>
					<div className="post__tweetBtm">
						<div className="post__handles">
